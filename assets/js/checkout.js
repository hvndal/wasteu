const MA_ONLINE = ['Seekonk','Rehoboth','Swansea','Somerset','Fall River','Attleboro','North Attleboro','Dighton','Taunton','Raynham','Norton','Mansfield','Foxborough','Sharon','Easton','Freetown','Lakeville','Berkley','Dartmouth','New Bedford','Fairhaven','Acushnet','Westport'];
